...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-brand-500/30">
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-4 md:p-6 lg:p-8 h-screen flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-6 min-h-0">
          {/* Left Panel: Config */}
          <div className="lg:col-span-4 bg-slate-900/80 backdrop-blur-xl border border-slate-700/60 rounded-3xl p-6 shadow-2xl flex flex-col h-[calc(100vh-140px)] lg:h-auto overflow-hidden">
            <ConfigPanel 
              values={inputs} 
